...
const Skills = () => {
  return (
    <section id="skills" className="mt-[6rem] px-[2rem] flex flex-col gap-[3rem]">
      <h2 className="headers"># Skills</h2>
      <div className="flex w-full">
        <div className="flex flex-col gap-[2rem] laptop:w-[60%]">
          {skills.map((Element) => {
        ...
        <div className="relative flex w-0 items-start justify-end laptop:w-[40%]">
          ...
          <div className="laptop:background2 absolute -top-[2rem] bottom-0  left-[-103px] right-0"></div>
        </div>
      </div>
    </section>
  );
